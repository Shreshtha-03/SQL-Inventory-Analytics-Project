--creating the structure of raw inventory table
...
--identifying the variety of entities
SELECT COUNT(DISTINCT store_id),
       COUNT(DISTINCT product_id)
FROM raw_inventory;

--identifying the time horizon of dataset
SELECT MIN(date),
       MAX(date)
FROM raw_inventory;

--duplicate detection and primary key validation
SELECT
    date,
    store_id,
    product_id,
